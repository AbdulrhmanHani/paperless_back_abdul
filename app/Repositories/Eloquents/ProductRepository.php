...
class ProductRepository extends BaseRepository
{
    ...
    public function show($id)
    {
        try {
            ...
            return new ProductResource($this->model->with(config('enums.product.with'))
                ->get()
    ...
    public function store($request)
    {
        ...
        try {
            ...
            $paper_image = Storage::putFile('products', $request->paper_image);
            $envelope_image = Storage::putFile('products', $request->envelope_image);
            if ($request->hasFile('backdrop_image')) {
                $backdrop_image = Storage::putFile('products', $request->backdrop_image);
            } else {
                $backdrop_image = null;
            }
            $product_photos = ProductPhoto::create([
