...
class CreateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'quantity' => ['nullable', 'numeric', 'required_if:type,==,simple'],
            ...
            'is_cod' => ['min:0', 'max:1'],
            'is_return' => ['nullable', 'min:0', 'max:1'],
            'is_free_shipping' => ['nullable', 'min:0', 'max:1'],
            'is_changeable' => ['min:0', 'max:1'],
            'is_sale_enable' => ['nullable', 'min:0', 'max:1'],
            ...
            'variations.*.stock_status' => ['nullable', 'in:in_stock,out_of_stock,coming_soon'],
            ...
            'paper_image' => ['required', 'image', 'mimes:png,jpg,gif'],
            'envelope_image' => ['required', 'image', 'mimes:png,jpg,gif'],
            'backdrop_image' => ['nullable', 'image', 'mimes:png,jpg,gif'],
        ];
    }
