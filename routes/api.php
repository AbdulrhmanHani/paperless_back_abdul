...
Route::group(['middleware' => ['localization', 'auth:sanctum']], function () {
    ...
    Route::apiResource('designers', 'App\Http\Controllers\DesignersController')->except('show');
    // Products
    Route::apiResource('product', 'App\Http\Controllers\ProductController', [
        'only' => ['store', 'update', 'destroy'],
    ]);
    Route::get('product/show/designer/{designer_id}', [ProductController::class, 'getProductsByDesigns'])->middleware('auth:sanctum');
    ...
    # Admin Can add plans
    // show plans
    Route::get('coin/plans', 'App\Http\Controllers\PointsController@showCoinPlan')->middleware('auth:sanctum');
    // create
    Route::post('coin/plans/add', 'App\Http\Controllers\PointsController@coinPlan')->middleware('auth:sanctum');
    // update
    Route::post('coin/plans/update/{coinPlanId}', 'App\Http\Controllers\PointsController@coinPlanUpdate')->middleware('auth:sanctum');
    // delete
    Route::get('coin/plans/delete/{coinPlanId}', 'App\Http\Controllers\PointsController@coinPlanDelete')->middleware('auth:sanctum');
...
// Event
Route::post('/create-event', [EventController::class, 'index'])->middleware('auth:sanctum');

// Invitation

# Qr_Code
// Send_Emails
Route::post('/send-invite', [InvitationController::class, 'index'])->middleware('auth:sanctum');

// Upload_Images
Route::post('/image-upload', [uploadImageController::class, 'index'])->middleware('auth:sanctum');

# Address_Book_Endpoints
// Get_All_Email_Addresses
Route::get('/book/all', [AddressBookController::class, 'index'])->middleware('auth:sanctum');
// Edit_Email_Addresses
Route::post('/book/edit/{book_id}', [AddressBookController::class, 'edit'])->middleware('auth:sanctum');
// Delete_Email_Addresses
Route::get('/book/delete/{book_id}', [AddressBookController::class, 'delete'])->middleware('auth:sanctum');
